...
export default {
  ...
  childrenNoError: "Prosim določite število otrok (starost: 2-12)",
  bookNow: "Rezerviraj",
  errorForm: "Prosim izpolnite vsa polja",
  success:
    "Hvala za poslano povpraševanje. Odgovor boste prejeli na vaš email v roku 24 ur.",
  ...
  minStay: "* min. št. dni najema: 3 dni (2 nočitvi)",
  ...
  surcharges1:
    "Zgodnja prijava: 30 EUR (možna ob 12.00 - samo ob predhodnem dogovoru)",
  ...
  season2: "sezona 2",
  season3: "sezona 3",
  app1: "posestvo (max. 4 oseb)**",
  moreInfo: "Več informacij",
  app2: "posestvo (max. 9 oseb)***",
