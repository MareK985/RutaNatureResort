<template>
  <div class="logo-container">
    <a href="http://mare-ux.com/" target="_blank">
      <span class="linkSpanner"></span>
    </a>
    <div class="logo-text">{{ $t("designedBy") }}</div>
    <svg
      id="mare"
      class="mare"
      version="1.1"
      ...
      style="enable-background:new 0 0 951.1 562.06;"
      xml:space="preserve"
    >
      <style type="text/css">
        .st0 {
      ...
      <g id="curv_x5F_mask">
        <defs>
          <path
            id="SVGID_1_"
            d="M153.75,326.39c-16.2,24.44-26.19,54.43-24.35,84.03c0.7,11.24,3.81,23.67,11.06,32.56
        ...
        <defs>
          <path
            id="SVGID_2_"
            d="M448.05,292.07c-13.16-0.17-26.6,3.47-36.8,12.1c-8.58,7.26-15.54,17.8-14.54,29.5
        ...
        <defs>
          <path
            id="SVGID_3_"
            d="M486.03,288.4c-1.81,17.59-3.61,35.18-5.42,52.76c-1.16,11.29,17.51,10.38,22.44,3.65
        ...
        <defs>
          <path
            id="SVGID_4_"
            d="M511.33,330.23c15.91,2.87,32.84,0.34,47.32-6.79c9.85-4.85,25.55-16.77,17.58-29.26
        ...
        <defs>
          <path
            id="SVGID_5_"
            d="M631.24,200.57c-12.28,17.92-20.86,38.08-25.63,59.27c-2.3,10.24-3.83,20.67-4.48,31.15
        ...
        <defs>
          <path
            id="SVGID_6_"
            d="M697.87,163.99c9.67,34.28,19.33,68.56,29,102.83c4.83,17.14,9.67,34.28,14.5,51.42
        ...
        <defs>
          <path
            id="SVGID_7_"
            d="M821.84,284.81c1.14-5.63,2.29-11.27,3.43-16.9c1.44-7.08-11.4-6.56-15.41-5.38
        ...
        <g id="m-1" class="st6">
          <g class="st7">
            <path
              d="M153.66,328.56c-14.06,22.02-26.7,47.33-27.35,73.96c-0.33,13.23,2.56,25.73,9.57,37.03
        ...
        <g id="x-1" class="st6">
          <g class="st7">
            <path
              d="M698.21,165.84c9.58,33.96,19.15,67.92,28.73,101.88c4.74,16.82,9.49,33.64,14.23,50.46
